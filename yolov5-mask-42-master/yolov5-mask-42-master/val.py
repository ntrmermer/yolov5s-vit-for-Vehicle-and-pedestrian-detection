...
# python val.py --data data/mask_data.yaml --weights runs/train/exp30/weights/best.pt --img 640
if __name__ == "__main__":
    opt = parse_opt()
    main(opt)
# python val.py --data data.yaml --weights runs/train/exp13/weights/best.pt --img 640