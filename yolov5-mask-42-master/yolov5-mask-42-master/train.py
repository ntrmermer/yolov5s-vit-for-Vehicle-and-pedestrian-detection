...
# python train.py --data mask_data.yaml --cfg mask_yolov5s.yaml --weights pretrained/yolov5s.pt --epoch 50 --batch-size 4 --device cpu
...
# python train.py --data data.yaml --cfg yolov5s.yaml --weights pretrained/yolov5s.pt --epoch 5 --batch-size 4 --device cpu
# python train.py --data data.yaml --cfg yolov5s.yaml --weights pretrained/yolov5s.pt --epoch 5 --batch-size 4 --device cpu
# python train.py --data mask_data.yaml --cfg yolov5s+vit.yaml --epoch 50 --batch-size 4 --device cpu
# python train.py --data mask_data.yaml --cfg yolov5s+vitplus.yaml --epoch 50 --batch-size 4 --device cpu